...
exports.WrongMatrixStructureError = exports.NotTheSameColumnsLengthError = exports.NotTheSameSchemaError = exports.NoSuchColumnError = exports.SchemaTypeError = exports.SchemaError = exports.EmptyInputError = exports.InputTypeError = undefined;
...
var NotTheSameColumnsLengthError = exports.NotTheSameColumnsLengthError = function (_Error7) {
    (0, _inherits3.default)(NotTheSameColumnsLengthError, _Error7);

    function NotTheSameColumnsLengthError(length, expected) {
        (0, _classCallCheck3.default)(this, NotTheSameColumnsLengthError);

        var _this7 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(NotTheSameColumnsLengthError).call(this));

        _this7.message = 'NotTheSameColumnsLengthError: [' + length + '] while expecting [' + expected + ']';
        _this7.name = 'NotTheSameColumnsLengthError';
        return _this7;
    }

    return NotTheSameColumnsLengthError;
}(Error);
