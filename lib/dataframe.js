...
var DataFrame = function () {
    ...
    *      {c1: 6, c5: 6, c2: 9, c4: 8, c3: 9, c6: 12}, // Row Data
    ...
    function DataFrame(data, columns) {
        ...
        _assign2.default.apply(Object, [this].concat((0, _toConsumableArray3.default)(this.__instanciateModules__(modules))));
    }
    ...
    (0, _createClass3.default)(DataFrame, [{
        ...
        value: function replace(value, replacment) {
            for (var _len2 = arguments.length, columnNames = Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
                columnNames[_key2 - 2] = arguments[_key2];
            }
