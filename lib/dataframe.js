    ...
    (0, _createClass3.default)(DataFrame, [{
        ...
        value: function _build(data, columns) {
            ...
            return (0, _reusables.match)(data, [function (value) {
                ...
                return _this2._fromArray(data, columns ? columns : (0, _keys2.default)((0, _reusables.asArray)(data.reduce(function (p, n) {
                    return (0, _reusables.asArray)(p).length > (0, _reusables.asArray)(n).length ? p : n;
                }))));
            }], [function (value) {
