    ...
    (0, _createClass3.default)(DataFrame, [{
        ...
        value: function _build(data, columns) {
            ...
            return (0, _reusables.match)(data, [function (value) {
                ...
                throw new _errors.EmptyInputError(typeof data === 'undefined' ? 'undefined' : (0, _typeof3.default)(data));
            }], [function (value) {
                return value instanceof Object && (0, _keys2.default)(value).length === 0;
            }, function () {
                throw new _errors.EmptyInputError(typeof data === 'undefined' ? 'undefined' : (0, _typeof3.default)(data));
            }], [function (value) {
