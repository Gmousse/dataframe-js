...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stat = __webpack_require__(448);

	var _stat2 = _interopRequireDefault(_stat);

	var _matrix = __webpack_require__(449);

	var _matrix2 = _interopRequireDefault(_matrix);

	var _sql = __webpack_require__(450);

	var _sql2 = _interopRequireDefault(_sql);

	var _benchmark = __webpack_require__(452);

	var _benchmark2 = _interopRequireDefault(_benchmark);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_dataframe2.default.defaultModules = [_stat2.default, _matrix2.default, _sql2.default];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataFrame = function () {
	    (0, _createClass3.default)(DataFrame, null, [{
	         ...
	         */
	        value: function isDataFrame(obj) {
	    ...
	    (0, _createClass3.default)(DataFrame, [{
	        ...
	        value: function toArray() {
	            var columnName = arguments.length <= 0 || arguments[0] === undefined ? undefined : arguments[0];

	            return columnName ? this.toDict()[columnName] : [].concat((0, _toConsumableArray3.default)(this)).map(function (row) {
	                return row.toArray();
	            });
	        }
	        ...
	        value: function distinct(columnName) {
	            return this.__newInstance__((0, _defineProperty3.default)({}, columnName, [].concat((0, _toConsumableArray3.default)(new _set2.default(this.toDict()[columnName])))), [columnName]);
	        }
	        ...
	        key: 'rename',
	        value: function rename(columnName, alias) {
	            var newColumnNames = this.listColumns().map(function (column) {
	                return column === columnName ? alias : column;
	            });
	        ...
	        *           .set('column2', p.get('column2') + n.get('column2'))
	        ...
	        value: function groupBy(columnName) {
	            return new _groupedDataframe2.default(this, columnName);
	        }
	        ...
	        *      [8, 1],
	        ...
	        value: function innerJoin(dfToJoin, on) {
	            ...
	            var actualGroupedDFs = this.groupBy(on).toDict()[on];
	            var groupedDFsToJoin = dfToJoin.groupBy(on).toDict()[on];
	            return [].concat((0, _toConsumableArray3.default)((0, _reusables.iter)([actualGroupedDFs, groupedDFsToJoin], function (groupedDF) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SQLParseError = exports.WrongMatrixStructureError = exports.NotTheSameColumnLengthsError = exports.NotTheSameSchemaError = exports.NoSuchColumnError = exports.SchemaTypeError = exports.SchemaError = exports.EmptyInputError = exports.InputTypeError = undefined;
	...
	var InputTypeError = exports.InputTypeError = function (_Error) {
	    ...
	    function InputTypeError(data, supportedTypes) {
	...
	var SQLParseError = exports.SQLParseError = function (_Error9) {
	    (0, _inherits3.default)(SQLParseError, _Error9);
	    ...
	    function SQLParseError(message) {
	        ...
	        _this9.message = 'SQLParseError: ' + message;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sqlEngine = __webpack_require__(451);
	...
	function parseSelections(selections) {
	    ...
	    return (0, _reusables.match)(selections.join(' ').split(','), [function (value) {
	        ...
	        return function (df) {
	            ...
	            return SELECT_FUNCTIONS[functionToApply](df, (0, _reusables.xReplace)(value[0], [functionToApply.toLowerCase() + '(', ''], [functionToApply + '(', ''], ['(', ''], [')', '']));
	        };
	    }], [function () {
	        return true;
	    }, function (value) {
