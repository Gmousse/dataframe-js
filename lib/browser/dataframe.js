	    ...
	    (0, _createClass3.default)(GroupedDataFrame, [{
	        ...
	        */
	        ...
	        value: function aggregate(func) {
	            var columnName = arguments.length <= 1 || arguments[1] === undefined ? 'aggregation' : arguments[1];
	        ...
	        value: function pivot(columnToPivot) {
	            var func = arguments.length <= 1 || arguments[1] === undefined ? function (gdf) {
	                return gdf.count();
	            } : arguments[1];
	            ...
	            return this.df.__newInstance__(this.aggregate(function (group) {
	                ...
	                var rest = (0, _objectWithoutProperties3.default)(_ref8, ['aggregation']);
	        ...
	        value: function melt() {
	            ...
	            var variableColumnName = arguments.length <= 0 || arguments[0] === undefined ? 'variable' : arguments[0];
	            var valueColumnName = arguments.length <= 1 || arguments[1] === undefined ? 'value' : arguments[1];
	            ...
	            return this.df.__newInstance__(this.aggregate(function (group) {
	                ...
	                var rest = (0, _objectWithoutProperties3.default)(_ref12, ['aggregation']);
